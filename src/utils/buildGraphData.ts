...
const TOPICS: TopicDefinition[] = [
  ...
  {
    id: 'graphics-tum-mvg-linear-algebra',
    label: 'MVG 线性代数',
    description: '向量空间、矩阵群、秩、零空间与 SVD 组成多视图几何的工具箱。',
    group: 'graphics',
    articleIds: ['tum-mvg-linear-algebra'],
  },
  {
    id: 'graphics-tum-mvg-moving-scene',
    label: 'MVG 运动表示',
    description: '用 SO(3)、SE(3)、Lie algebra 和 twist 表示相机与刚体运动。',
    group: 'graphics',
    articleIds: ['tum-mvg-moving-scene'],
  },
  {
    id: 'graphics-tum-mvg-perspective',
    label: 'MVG 透视投影',
    description: '从 pinhole camera 到 intrinsic matrix、畸变与 preimage/coimage。',
    group: 'graphics',
    articleIds: ['tum-mvg-perspective-projection'],
  },
  {
    id: 'graphics-tum-mvg-correspondence',
    label: 'MVG 点对应',
    description: '从 photometry 走向 geometry，理解 optical flow、Lucas-Kanade 与 wide-baseline matching。',
    group: 'graphics',
    articleIds: ['tum-mvg-point-correspondence'],
  },
  {
    id: 'graphics-tum-mvg-two-view',
    label: 'MVG 两视图重建',
    description: 'Epipolar constraint、essential matrix 与 eight-point algorithm 的线性重建主线。',
    group: 'graphics',
    articleIds: ['tum-mvg-two-view-reconstruction'],
  },
  {
    id: 'graphics-tum-mvg-multiple-view',
    label: 'MVG 多视图重建',
    description: '用 preimage、rank constraints 与 multiple-view matrix 组织多视图约束。',
    group: 'graphics',
    articleIds: ['tum-mvg-multiple-view-reconstruction'],
  },
  {
    id: 'graphics-tum-mvg-ba',
    label: 'MVG Bundle Adjustment',
    description: '用 reprojection error、Gauss-Newton 与 LM 在噪声中精修相机和结构。',
    group: 'graphics',
    articleIds: ['tum-mvg-bundle-adjustment'],
  },
  {
    id: 'graphics-tum-mvg-direct-slam',
    label: 'MVG Direct SLAM',
    description: '直接使用 photometric residual 做 dense、semi-dense 与 sparse visual SLAM。',
    group: 'graphics',
    articleIds: ['tum-mvg-direct-visual-slam'],
  },
  {
    id: 'graphics-tum-mvg-variational',
    label: 'MVG 变分方法',
    description: '把视觉问题写成 data term 与 regularizer 组成的能量最小化。',
    group: 'graphics',
    articleIds: ['tum-mvg-variational-methods'],
  },
  {
    id: 'graphics-tum-mvg-variational-reconstruction',
    label: 'MVG 变分重建',
    description: '用 shape representation、silhouette consistency 与 convex relaxation 做多视图形状优化。',
    group: 'graphics',
...
const STRUCTURAL_LINKS: Array<{ source: string; target: string; weight?: number }> = [
  ...
  { source: 'graphics-camera-model', target: 'graphics-tum-mvg-perspective' },
  { source: 'graphics-simple-stereo', target: 'graphics-tum-mvg-two-view' },
  { source: 'graphics-tum-mvg-linear-algebra', target: 'graphics-tum-mvg-moving-scene' },
  { source: 'graphics-tum-mvg-moving-scene', target: 'graphics-tum-mvg-perspective' },
  { source: 'graphics-tum-mvg-perspective', target: 'graphics-tum-mvg-correspondence' },
  { source: 'graphics-tum-mvg-correspondence', target: 'graphics-tum-mvg-two-view' },
  { source: 'graphics-tum-mvg-two-view', target: 'graphics-tum-mvg-multiple-view' },
  { source: 'graphics-tum-mvg-multiple-view', target: 'graphics-tum-mvg-ba' },
  { source: 'graphics-tum-mvg-ba', target: 'graphics-tum-mvg-direct-slam' },
  { source: 'graphics-tum-mvg-direct-slam', target: 'graphics-tum-mvg-variational' },
  { source: 'graphics-tum-mvg-variational', target: 'graphics-tum-mvg-variational-reconstruction' },
];
